        ...
        <div id="wellcome">
            <div className="container">
                <div className="wellcomeContainer">
                    ...
                    <div>
                        {
                            messege.split(/\s+/).slice(0, 100).join(' ')+" "
                        }
